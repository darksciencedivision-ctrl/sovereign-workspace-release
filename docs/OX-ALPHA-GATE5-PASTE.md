...
The directive follows in full. It is also on disk at docs/OX-ALPHA-DIRECTIVE-GATE5.md; if the two differ, the disk copy governs and you report the difference. Execute it in full. Do not pause at stage boundaries; the operator has waived stage pauses for this session, as the directive's section 1 records. Everything else in the directive and in AGENTS.md binds exactly as written.
