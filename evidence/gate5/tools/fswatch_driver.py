"""Gate 5 H-12 filesystem-watch driver (work order A-1).
...
next to this script, or on SIGINT/SIGBREAK. Produces evidence/gate5/fs-watch-gate5.txt with the
...
OUT = os.path.join(WS, "evidence", "gate5", "fs-watch-gate5.txt")
