...
class SuccessionManager:
    ...
    def perform_handoff(governor: Any, subscription_ref: str, predecessor_node: str,
        ...
        try:
            ...
            # W-72: compensate - restore the predecessor's hold, so a failed succession
            # never leaves the subscription held by nobody. Best effort; then raise.
            governor.acquire(subscription_ref, predecessor_node)
            raise
